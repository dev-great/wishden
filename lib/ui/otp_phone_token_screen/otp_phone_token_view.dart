...
import 'package:wishden/ui/otp_phone_token_screen/otp_phone_token_viewmodel.dart';
import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
import 'package:stacked/stacked.dart';

class OTPPhoneTokenView extends StatefulWidget {
  final String email;
  const OTPPhoneTokenView({super.key, required this.email});

  @override
  State<OTPPhoneTokenView> createState() => _OTPPhoneTokenViewState();
}

class _OTPPhoneTokenViewState extends State<OTPPhoneTokenView> {
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<OTPPhoneTokenViewModel>.reactive(
      viewModelBuilder: () => OTPPhoneTokenViewModel(),
